import { it, jest, describe, beforeAll, expect, afterAll } from '@jest/globals'
...
describe('E2E Test Suite', () => {
  ...
  describe('E2E Test for server', () => {
    ...
    it ('should return 400 and missing feald message for bad requests', async () => {
      const invalidPerson = { name: 'Fulano da Silva', cpf: '' }
